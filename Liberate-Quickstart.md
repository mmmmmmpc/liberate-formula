...
- Run the bootstrap script you created above, and the system will re-register using the same SUSE Manager profile as before, but with the newly assigned SLL/SLES-ES elements.
